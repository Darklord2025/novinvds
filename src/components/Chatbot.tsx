...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-50">
      ...
      {/* Chat window */}
      {isOpen && (
        <div className="fixed md:absolute bottom-0 left-0 right-0 md:bottom-16 md:left-0 md:right-auto w-full md:w-96 bg-white md:rounded-lg shadow-xl border border-gray-200 animate-scale-up origin-bottom md:origin-bottom-left max-h-[90vh] md:max-h-none">
          {/* Chat header */}
