  ...
  const announcements: Announcement[] = [
    {
      ...
      content: 'سرورهای ابری در تاریخ ۱۵ شهریور بروزرسانی خواهند شد. لطفاً برای جلوگیری از اختلال در سرویس، تمهیدات لازم را در نظر بگیرید. این به‌روزرسانی شامل ارتقای سیستم عامل و به‌روزرسانی‌های امنیتی است.\n\nزمان تقریبی اختلال: ۲ ساعت در بازه زمانی ۲ تا ۴ بامداد.\n\nاقدامات توصیه شده:\n۱. بک‌آپ گیری از اطلاعات مهم\n۲. اطلاع‌رسانی به کاربران\n۳. برنامه‌ریزی برای زمان خاموشی\n\nدر صورت نیاز به اطلاعات بیشتر با پشتیبانی تماس بگیرید.',
    ...
    },
    {
      ...
      content: 'به اطلاع کلیه مشتریان می‌رساند، از تاریخ ۱ مهر ۱۴۰۲، تغییراتی در سیاست‌های پشتیبانی اعمال خواهد شد. این تغییرات شامل ساعات پاسخگویی، روش‌های تماس و زمان رسیدگی به درخواست‌ها می‌باشد.\n\nجزئیات این تغییرات در وب‌سایت رسمی قابل مشاهده است.\n\nاز همراهی شما سپاسگزاریم.',
      date: toPersianDigits('1402/06/20'),
      type: 'info',
      important: true
    }
  ];
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-200">تعداد اطلاعیه‌ها: {toPersianDigits(announcements.length)}</Badge>
        </div>
      </div>
